...
#include "../config/ngx_c_conf.h"        //和配置文件处理相关的类,名字带c_表示和类有关
#include "../net/ngx_c_socket.h"      //和socket通讯相关
#include "../misc/ngx_c_memory.h"      //和内存分配释放等相关
#include "../misc/ngx_c_threadpool.h"  //和多线程有关
#include "../misc/ngx_c_crc32.h"       //和crc32校验算法有关 
#include "../logic/ngx_c_slogic.h"      //和socket通讯相关
...
{     
    ...
    if(p_config->Load("/home/lighthouse/test_cmake/search-engine/server/nginx.conf") == false) //把配置文件内容载入到内存            
    {   
        ngx_log_init();    //初始化日志
